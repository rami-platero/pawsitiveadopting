      ...
      <div className="min-h-[calc(100vh-68px)] flex flex-col items-center justify-center mx-4">
        <div className="max-w-6xl w-full flex flex-col items-center text-center gap-6 ">
          ...
          <div className="flex flex-col items-center gap-4 pt-4">
            <p className="text-sm text-foreground">{t("cta.title")}</p>
            <Link
              href="/association-signup"
              className="sm:px-8 px-4 py-3 bg-secondary text-primary-foreground rounded-full font-semibold hover:opacity-90 transition-opacity text-sm"
            >
              {t("cta.link")}
            </Link>
          </div>
